<div class="phones index">
	...
	<tr>
		...
		<td><?php echo h($phone['Phone']['contact_id']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $phone['Phone']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $phone['Phone']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
